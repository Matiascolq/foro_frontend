          ...
          <div className="mx-auto flex w-full max-w-4xl flex-col gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Reglas básicas para mantener el Foro UDP como un espacio seguro, respetuoso y útil para toda la comunidad.
              </p>
            </div>
              ...
              <CardHeader className="flex flex-row items-center gap-3 space-y-0">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    El objetivo del foro es apoyar el aprendizaje, coordinar actividades y compartir información académica. 
                    Cualquier falta grave de respeto puede significar la suspensión o expulsión del sistema.
                  </p>
                </div>
              </CardHeader>
            </Card>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border border-border/70 bg-card/70 backdrop-blur">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-base">1. Cero tolerancia a odio y discriminación</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  <p>
                    No se permite contenido que promueva <strong>racismo, xenofobia, homofobia, sexismo</strong> 
                    ni ningún tipo de discurso de odio o discriminación.
                  </p>
              ...
              <Card className="border border-border/70 bg-card/70 backdrop-blur">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-base">2. Comunicación responsable</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  <p>
              ...
              <Card className="border border-border/70 bg-card/70 backdrop-blur">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-base">3. Enfoque académico y comunitario</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  <p>
                    El foro está pensado para temas relacionados con la universidad, las asignaturas
                    y la vida académica.
                  </p>
                  <ul className="list-disc pl-5 space-y-1">
              ...
              <Card className="border border-border/70 bg-card/70 backdrop-blur">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    <Shield className="h-5 w-5 text-primary" />
                    <CardTitle className="text-base">4. Moderación y consecuencias</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  <p>
            ...
            <Card className="border border-border/70 bg-card/70 backdrop-blur">
              <CardContent className="py-4 text-sm text-muted-foreground">
                Al usar este foro aceptas estas normas de convivencia. Si tienes dudas o quieres sugerir 
                mejoras a las reglas, puedes hacerlo a través de los canales oficiales o con tu moderador/a.
              </CardContent>
            </Card>
          </div>
        </div>
